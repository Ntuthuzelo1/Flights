    ...
    public class FlightController : ControllerBase
    {
        ...
        public IActionResult Book(BookDto dto)
        {
            ...
            if (error is OverbookError)
                return Conflict(new { message = "The number of seats being booked exceeds the number of seats available." });
            ...
            {
                return Conflict(new { message = "Oops! Someone just recently booked the remaining ticket before yours was processed." });
            }
